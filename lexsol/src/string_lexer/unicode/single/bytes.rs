...
impl StringToken {
  ...
  pub(crate) fn lex_unicode<'a, S, T, Error, Container>(
    lexer: &mut SingleQuotedUnicodeStrLexer<Lexer<'a, T>, u8, UnicodeStringError<u8>, Error>,
...
impl<'a, S, T, Error, Container>
  Lexable<
    &mut SingleQuotedUnicodeStrLexer<Lexer<'a, T>, u8, UnicodeStringError<u8>, Error>,
    Container,
