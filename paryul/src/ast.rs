use crate::{SyntaxKind, YUL, scaffold::ast, error::AstParserError};

use derive_more::{From, IsVariant, TryUnwrap, Unwrap};

use lexsol::types::keywords::{Break, Continue, Leave};
use logosky::{IdentifierToken, KeywordToken, Lexed, LitToken, LogoStream, Logos, PunctuatorToken, Require, Source, Token, chumsky::{Parseable, Parser, extra::ParserExtra, prelude::*, token::punct::brace_close}, error::{UnexpectedEot, UnexpectedToken}, utils::{Spanned, cmp::Equivalent}};
...
/// 
/// Spec: [Yul Function Call](https://docs.soliditylang.org/en/latest/grammar.html#syntax-rule-SolidityParser.yulFunctionCall)
pub type FunctionCall<S> = ast::statement::function_call::FunctionCall<
  FunctionCallName<S>,
  Expression<S>,
>;
...
pub type SingleTargetAssignment<S> = ast::statement::assignment::SingleTargetAssignment<
  Path<S>,
  Expression<S>,
>;
...
pub type MultipleTargetAssignment<S> = ast::statement::assignment::MultipleTargetAssignment<
  Path<S>,
  Expression<S>,
>;
...
pub type Assignment<S> = ast::statement::assignment::Assignment<
  Path<S>,
  Expression<S>,
  FunctionCall<S>,
>;
...
pub type SingleVariableDeclaration<S> = ast::statement::variable_declaration::SingleVariableDeclaration<
  Ident<S>,
  Expression<S>,
>;
...
/// 
/// Spec: [Yul Variable Declaration](https://docs.soliditylang.org/en/latest/grammar.html#syntax-rule-SolidityParser.yulVariableDeclaration)
pub type MultipleVariableDeclaration<S> = ast::statement::variable_declaration::MultipleVariableDeclaration<
  FunctionCallName<S>,
  FunctionCall<S>,
>;
...
pub type Block<S> = ast::statement::block::Block<
  Statement<S>,
>;
...
pub type IfStatement<S> = ast::statement::if_statement::IfStatement<
  Expression<S>,
  Block<S>,
>;
...
pub type ForStatement<S> = ast::statement::for_statement::ForStatement<
  Block<S>,
  Expression<S>,
  Block<S>,
  Block<S>,
...
pub type SwitchCase<S> = ast::statement::switch_statement::SwitchCase<
  Lit<S>,
  Block<S>,
>;
...
pub type DefaultCase<S> = ast::statement::switch_statement::DefaultCase<
  Block<S>,
>;
...
/// 
/// Spec: [Yul Switch Case](https://docs.soliditylang.org/en/latest/grammar.html#syntax-rule-SolidityParser.yulSwitchStatement)
pub type Case<S> = ast::statement::switch_statement::Case<
  Lit<S>,
  Block<S>,
>;
...
pub type SwitchStatement<S> = ast::statement::switch_statement::SwitchStatement<
  Expression<S>,
  Case<S>,
>;
...
pub type FunctionDefinitionArguments<S> = ast::statement::function_definition::FunctionDefinitionArguments<
  Ident<S>,
>;
...
pub type FunctionDefinitionReturnParameters<S> = ast::statement::function_definition::FunctionDefinitionReturnParameters<
  Ident<S>,
>;
